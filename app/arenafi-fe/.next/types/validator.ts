...
// Validate ../../app/api/create-wallet/route.ts
{
...
// Validate ../../app/api/user/[email]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/user/[email]">> = Specific
  const handler = {} as typeof import("../../app/api/user/[email]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
